...
const char* WINDOWTITLE = { "Final Project -- Haotian Jia" };
...
Display()
{
	...
	glLoadIdentity();
	glColor3f(1., 1., 1.);
	DoRasterString( 5., 5., 0., "Haotian Jia --- Final Project" );
...
InitMenus()
{
	...
	glutAddSubMenu("Lighting", discomenu);
...
InitGraphics()
{
	...
	//Sun Texture
	Texture = BmpToTexture("disco.bmp", &Width, &Height);
	...
	//Earth Texture
	Texture = BmpToTexture("soccer.bmp", &Width, &Height);
	if (Texture == NULL || Width != 241 || Height != 209)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
	...
	Texture = BmpToTexture("football.bmp", &Width, &Height);
	if (Texture == NULL || Width != 285 || Height != 177)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
	...
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
	//Saturn Texture
	Texture = BmpToTexture("basketball.bmp", &Width, &Height);
	if (Texture == NULL || Width != 269 || Height != 188)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
	...
	//Uranus Texture
	Texture = BmpToTexture("golf.bmp", &Width, &Height);
	if (Texture == NULL || Width != 225 || Height != 225)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
	...
	//Neptune Texture
	Texture = BmpToTexture("tennis.bmp", &Width, &Height);
	if (Texture == NULL || Width != 275 || Height != 183)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
	...
	glTexImage2D(GL_TEXTURE_2D, 0, 3, Width, Height, 0, GL_RGB, GL_UNSIGNED_BYTE, Texture);
	//Pluto Texture
	Texture = BmpToTexture("billiards.bmp", &Width, &Height);
	if (Texture == NULL || Width != 318 || Height != 159)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
	...
	//Sky Texture
	Texture = BmpToTexture("discomap.bmp", &Width, &Height);
	if (Texture == NULL || Width != 259 || Height != 194)
	{
		printf("Wrong Reading BMP File!");
		exit(1);
	}
